...
{
    public class PowerComp : MonoBehaviour, IComboMonitor
    {
        private IComboReceiver _skillComp;
        ...
        private void Awake()
        {
            _skillComp = GetComponent<IComboReceiver>();
    ...
    public interface IComboMonitor
    {
        public void SetSpecialAttack(int attackIndex);
        public void PowerUp();
        public void ResetPowerBar();
