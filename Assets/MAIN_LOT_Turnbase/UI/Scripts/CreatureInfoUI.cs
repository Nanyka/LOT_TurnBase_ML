...
namespace JumpeeIsland
{
    public class CreatureInfoUI : MonoBehaviour
    {
        ...
        private void ShowUnitInfo(IShowInfo infoGetter)
        {
            ...
            {
                var creatureItem = SavingSystemManager.Instance.GetInventoryItemByName(creatureEntity.GetData().EntityName);
            ...
            {
                var buildingItem = SavingSystemManager.Instance.GetInventoryItemByName(buildingEntity.GetData().EntityName);
