...
public class BasicXZActuatorComponent : ActuatorComponent
{
    [SerializeField] private BasicXZController _controller;
    private ActionSpec _actionSpec = ActionSpec.MakeDiscrete(5);

    public override IActuator[] CreateActuators()
    {
        return new IActuator[] {new BasicXZActuator(_controller)};
    }
...
public class BasicXZActuator : IActuator
{
    private BasicXZController _controller;
    ActionSpec m_ActionSpec;

    public BasicXZActuator(BasicXZController controller)
    {
